/**
 * ============================================================
 *  FixMate — אייקוני SVG של מסכי ההתחברות וההרשמה
 *  קובץ אחד לשני המסכים — קודם כל אייקון הוגדר פעמיים.
 *
 *  ל-size יש ברירת מחדל, כך שכל מסך מקבל בדיוק את הגודל
 *  שהיה לו קודם ושום דבר לא משנה מראה.
 * ============================================================
 */

/* ── משותפים ל-SignIn ול-SignUp ── */
...
/* SignIn משתמש ב-26px, SignUp ב-36px — לכן size */
export const IconWrench = ({ size = 26 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
  </svg>
);
export const IconHome = ({ size = 26 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
